...
# ==========================================
# 3. เตรียมข้อมูล Category และ Subcategory
# ==========================================
item_data_map = {}
